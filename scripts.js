...
var rawCsv = "1:1:1 Twin Princes,Faint Memory (Green),Sword Jadeite,Bow Jadeite,Earth Alcryst (Green),Ranger's Memory (Green),Warrior's Memory (Green),Praying Angel Statue (Green),Sorrowful Heart,Murky Fluid,\n" +
  ...
  "1:3:7 What Has Been Lost,Faint Memory (Blue),Katana Azurite,Ninja Blade Azurite,Axe Azurite,Wind Alcryst (Blue),Lancer's Memory (Blue),Time Mage's Memory (Blue),Praying Angel Statue (Blue),Sorrowful Heart,Murky Fluid,Iron Mace Crafting Recipe\n" +
